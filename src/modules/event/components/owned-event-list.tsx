                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        {isResubmittableEventStatus(event.status) ? (
                          ...
                          >
                            {isPending && confirmation?.event.id === event.id && confirmation?.action === "post" ? (
                        ...
                        {event.status === "PUBLISHED" ? (
                          ...
                          >
                            {isPending && confirmation?.event.id === event.id && confirmation?.action === "archive" ? (
                              <Loader2 className="size-3.5 animate-spin" />
                            ) : (
                        ...
                        {event.status === "ARCHIVED" ? (
                          <Button
                            ...
                            className="gap-1.5 bg-emerald-600 text-xs text-white hover:bg-emerald-700 min-h-[36px] px-2.5 active:scale-95"
                          >
                            {isPending && confirmation?.event.id === event.id && confirmation?.action === "republish" ? (
                              <Loader2 className="size-3.5 animate-spin" />
                            ) : (
                        ...
                        {isDeletableEventStatus(event.status) ? (
                          ...
                          >
                            {isPending && confirmation?.event.id === event.id && confirmation?.action === "delete" ? (
                              <Loader2 className="size-3.5 animate-spin" />
                            ) : (
