...
export function FirstTimeSetupPage() {
  ...
  return (
    <AuthPageShell asideDescription="Inisialisasi awal sistem Benah Palembang. Buat akun SuperAdmin pertama untuk mengelola platform.">
      <div className="mt-12 inline-flex items-center gap-2 rounded-full border border-palembang-red/30 bg-palembang-red/10 px-3.5 py-1 text-xs font-semibold text-palembang-red">
