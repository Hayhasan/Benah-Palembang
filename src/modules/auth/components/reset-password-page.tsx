  ...
  return (
    <AuthPageShell asideDescription="Buat password baru untuk mengamankan kembali akun Anda.">
      ...
      {tokenStatus.status !== "valid" ? (
        <div className="mt-8 rounded-xl border border-red-500/25 bg-red-500/10 p-6">
          ...
          <Button
            asChild
            className="mt-5 bg-palembang-red font-bold text-white hover:bg-palembang-red/90 cursor-pointer"
          >
        ...
        <>
          ...
          <form action={formAction} className="mt-8 space-y-4" noValidate>
            ...
            <Button
              type="submit"
              disabled={isPending}
              className="h-11 w-full bg-palembang-red font-bold text-white hover:bg-palembang-red/90 cursor-pointer shadow-sm"
            >
