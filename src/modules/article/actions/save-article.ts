      ...
      if (data.id) {
        ...
        const article = await transaction.article.update({
          ...
          data: {
            ...
            additionalBannerUrls: data.additionalBannerUrls,
            readingTime,
            photographer: data.photographer || null,
            additionalPhotographers: data.additionalPhotographers,
            venueName: data.venueName || null,
            venueAddress: data.venueAddress || null,
            venuePriceLevel: data.venuePriceLevel ?? 1,
            venueOpenDays: data.venueOpenDays || null,
            venueOpenHours: data.venueOpenHours || null,
        ...
        const changes = buildArticleChangeSummary(
          {
            ...
            additionalBannerUrls: currentArticle.additionalBannerUrls,
            categorySlug:
              currentArticle.websiteArticleSection.articleCategorySlug,
            tags: currentArticle.tags.map((tag) => tag.label),
            photographer: currentArticle.photographer,
            additionalPhotographers: currentArticle.additionalPhotographers,
            venueName: currentArticle.venueName,
            venueAddress: currentArticle.venueAddress,
            venuePriceLevel: currentArticle.venuePriceLevel,
            venueOpenDays: currentArticle.venueOpenDays,
            venueOpenHours: currentArticle.venueOpenHours,
            venueFeatures: currentArticle.venueFeatures,
            venueContact: currentArticle.venueContact,
          },
          {
            title: data.title,
            excerpt: data.excerpt,
