    ...
    <section className={`relative overflow-hidden ${bgClass} px-6 py-24 sm:px-10 lg:px-16 lg:py-32`}>
      ...
      <div className="relative z-10 mx-auto max-w-[1240px]">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <Link href={`/${meta.slug}`} className={`group hidden items-center gap-3 text-xs font-bold uppercase tracking-[0.15em] md:flex ${linkClass}`}>
        ...
        <div className="mt-12 flex justify-end md:hidden">
          <Link href={`/${meta.slug}`} className={`group flex items-center gap-3 text-xs font-bold uppercase tracking-[0.15em] ${linkClass}`}>
            Lihat semua <span className={`rounded-full border p-2 transition-colors ${btnBorder}`}><ArrowRight className="size-4" /></span>
          </Link>
        </div>
      </div>
        ...
        <div className="flex flex-col justify-center p-8 text-white sm:p-14">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/lupa-password" className="text-[11px] font-medium text-palembang-gold/80 transition-colors hover:text-palembang-gold hover:underline">
                Lupa password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-xs text-white/50">
            Belum punya akun? <Link href="/register" className="font-semibold text-palembang-gold hover:underline">Daftar sekarang</Link>
          </p>
        </div>
      </div>
    </main>
    ...
    <main className="flex min-h-svh items-center justify-center bg-palembang-charcoal px-6 py-32">
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[1.5rem] border border-white/10 bg-black/40 shadow-xl backdrop-blur-sm lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center p-8 text-white sm:p-14">
          ...
          <p className="mt-8 text-center text-xs text-white/50">
            Sudah punya akun? <Link href="/login" className="font-semibold text-palembang-gold hover:underline">Masuk sekarang</Link>
          </p>
        </div>
      </div>
    </main>
        ...
        <div className="flex flex-col justify-center p-8 text-white sm:p-14">
          ...
          {sent ? (
            <div className="mt-8 rounded-xl border border-palembang-gold/30 bg-palembang-gold/10 p-6">
              ...
              <Link href="/login" className="mt-5 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.14em] text-palembang-gold hover:underline">
          ...
          <p className="mt-8 text-center text-xs text-white/50">
            Sudah ingat? <Link href="/login" className="font-semibold text-palembang-gold hover:underline">Masuk sekarang</Link>
          </p>
        </div>
      </div>
    </main>
...
function CTASection() {
  return <section className="bg-palembang-red px-6 py-24 text-white sm:px-10 lg:px-16 lg:py-32"><div className="mx-auto flex max-w-[1240px] flex-col justify-between gap-12 lg:flex-row lg:items-end"><div><p className="text-[10px] font-bold uppercase tracking-[0.22em] text-white/70">Buka ruang kolaborasi</p><h2 className="mt-5 max-w-3xl font-display text-5xl font-black leading-[0.92] tracking-[-0.06em] sm:text-7xl">Kota ini milik<br />kita semua.</h2></div><div className="max-w-sm"><p className="text-sm leading-7 text-white/75">Punya cerita, ide, atau ingin membuat sesuatu bersama? Kami ingin mendengarnya.</p><Link href="/kolaborasi" className="mt-7 flex w-fit items-center gap-3 rounded-full bg-white px-5 py-3 text-xs font-bold uppercase tracking-[0.14em] text-palembang-charcoal transition-transform hover:-translate-y-1">Let's collaborate <ArrowRight className="size-4" /></Link></div></div></section>
}
